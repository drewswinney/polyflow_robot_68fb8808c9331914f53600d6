...
let
  user      = "admin";
  password  = "password";
  hostname  = "68fb8808c9331914f53600d6";  # keep your template if you render it; otherwise set a real name
...
in
{
  ...
  systemd.services.polyflow-webrtc = {
    ...
    script = ''
      ...
      NIX_ROS_PREFIXES="${ros-pkgs.rosPackages.humble.ros2cli}:${ros-pkgs.rosPackages.humble.ros2launch}:${ros-pkgs.rosPackages.humble.launch_ros}:${ros-pkgs.rosPackages.humble.ros-base}"
